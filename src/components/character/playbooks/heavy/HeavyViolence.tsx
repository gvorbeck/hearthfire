...
export const HeavyViolence = ({ data, onSave }: PlaybookSectionProps) => (
  <PlaybookChecklistSection
    title="A History of Violence"
    featureKey="heavyViolence"
    intro="Just about everyone here talks about the time you… (pick 1 or 2)"
    groups={GROUPS}
    data={data}
    onSave={onSave}
  />
