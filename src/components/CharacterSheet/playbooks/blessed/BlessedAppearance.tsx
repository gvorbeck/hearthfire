...
import styles from './BlessedAppearance.module.css';
...
interface BlessedAppearanceProps {
  data: CharacterData | undefined;
  onSave: (data: Partial<CharacterData>) => Promise<void>;
}

export const BlessedAppearance = ({ data, onSave }: BlessedAppearanceProps) => {
  ...
  const handleSelect = useCallback((rowIndex: number, value: string) => {
            ...
            <div className={styles.options}>
              {options.map((opt) => (
                <Radio
                  ...
                  disabled={isCustom}
                  onChange={() => handleSelect(rowIndex, opt)}
