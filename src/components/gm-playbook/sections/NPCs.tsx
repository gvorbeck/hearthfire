  ...
  <div>
    ...
    <div className={styles.subsection}>
      ...
      <div className={playbookStyles.paragraphs}>
        ...
        <Text>**Body:** big, heavyset, little, lithe, meaty, missing ___, round, short, stooped, tall, thick, thin, wiry, etc.</Text>
        <Text>**Presence:** alert, brooding, cheery, elegant, fidgety, friendly, haughty, hunched, intense, serene, etc.</Text>
    ...
    <div className={styles.subsection}>
      <Heading as="h3" size="sm">
        Tags &amp; moves <span className={playbookStyles.muted}>(optional)</span>
      </Heading>
      <Text>Assign tags as you see fit, adjectives or nouns that describe their nature, capabilities (or lack thereof), or notable traits: *cunning, gullible, bold, cautious, warrior, farmer, devious, honest*, etc.</Text>
    ...
    <div className={styles.subsection}>
      <Heading as="h3" size="sm">
        Connections <span className={playbookStyles.muted}>(optional)</span>
      </Heading>
    ...
    <div className={styles.subsection}>
      <Heading as="h3" size="sm">
        Motivations <span className={playbookStyles.muted}>(optional)</span>
      </Heading>
    ...
    <div className={styles.subsection}>
      <Heading as="h3" size="sm">
        HP, armor, damage <span className={playbookStyles.muted}>(optional)</span>
      </Heading>
