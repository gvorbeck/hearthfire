...
export const Sites = () => (
  <div>
    ...
    />
    <Text>
      In every area/room/scene, include at least one detail or element that
      reflects the site's story.
    </Text>
    ...
    <div className={styles.subsection}>
      ...
      <Text>
        Play out scenes/situations set in or inspired by the site. Run the core
    ...
    <div className={styles.subsection}>
      ...
      <Text>
        When the PCs move on, identify the next interesting scene/situation in
        the site. Establish the PCs intent, compare to your prep or sense of the
        site. If the next scene/situation is obvious, great.
      </Text>
      ...
      />
      <Text>
        Then frame the action at the next scene or situation, and go from there.
      </Text>
    </div>
