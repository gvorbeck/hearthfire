...
export const SPECIAL_MOVES: MoveDefinition[] = [
  ...
  },
  {
    id: 'burn-brightly',
    name: 'Burn Brightly',
    trigger: 'have enough XP to Level Up (6 + twice your current level)',
    body: 'you may spend 2 XP after any roll you make to add +1 to that roll (max +1 per roll).',
  },
  {
    id: 'deaths-door',
    name: "Death's Door",
  ...
  },
  {
    id: 'end-of-session',
    name: 'End of Session',
    triggerOverride: 'When a **session ends**,',
    body: [
