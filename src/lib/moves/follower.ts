...
export const FOLLOWER_MOVES: MoveDefinition[] = ([
  {
    ...
    body: [
      { kind: 'para', text: 'When you **direct your follower to do something that would trigger a player move**, and they do it, they trigger the move. If the move involves rolling, you roll for them. Instead of rolling +STAT, roll and...' },
      { kind: 'list', items: [
      ...
      { kind: 'para', text: 'When a follower is without orders or they act on their own initiative, the GM says what they do and decides how it goes.' },
    ],
  ...
  },
  {
    ...
    body: [
      { kind: 'para', text: "When you **pay your follower's cost**, and you haven't done so recently, they hold +1 Loyalty (max 3)." },
      { kind: 'para', text: 'Spend your follower\'s Loyalty 1-for-1 to have them:' },
      { kind: 'list', items: [
