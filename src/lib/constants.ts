...
export const PLAYBOOKS: PlaybookOption[] = [
  {
    ...
    damage: "d6",
    choose: 4,
    helperText: "You start with Spirit Tongue, Call the Spirits, 1 from your Background, and 1 of your choice.",
  },
  {
    value: "fox",
    label: "The Fox",
    ...
    hpMax: 16,
    damage: "d8",
    helperText: "You start with Ambush OR Skill at Arms; Danger Sense OR Perceptive; and 1 of your choice.",
  },
  {
    value: "heavy",
    label: "The Heavy",
    ...
    hpMax: 20,
    damage: "d10",
    helperText: "You start with Dangerous, Hard to Kill, and either Armored OR Uncanny Reflexes.",
  },
  {
    value: "judge",
    label: "The Judge",
    ...
    hpMax: 20,
    damage: "d6",
    helperText: "You start with Censure, Chronicler of Stonetop, plus 2 more of your choice.",
  },
  {
    value: "lightbearer",
    ...
    hpMax: 18,
    damage: "d4",
    helperText: "You start with Consecrated Flame and Invoke the Sun God, plus 1 more of your choice.",
  },
  {
    value: "marshal",
    label: "The Marshal",
    ...
    hpMax: 20,
    damage: "d8",
    helperText: "You start with Crew, Logistics, any moves from your Background, and 1 move of your choice.",
  },
  {
    value: "ranger",
    label: "The Ranger",
    ...
    hpMax: 18,
    damage: "d8",
    helperText: "You start with Home on the Range, any moves from your Background, plus 1 of your choice.",
  },
  {
    value: "seeker",
    label: "The Seeker",
    ...
    hpMax: 16,
    damage: "d6",
    helperText: "You start with Well Versed, Work With What You've Got, plus 1 from your Background.",
  },
  {
    value: "would-be-hero",
    ...
    hpMax: 16,
    damage: "d6",
    helperText: "You start with Anger is a Gift, Potential for Greatness, and 2 other moves of your choice.",
  },
];
