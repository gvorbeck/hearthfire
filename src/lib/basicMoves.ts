...
export const BASIC_MOVES: MoveDefinition[] = [
  {
    id: 'aid',
    name: 'Aid',
    triggerOverride: 'When you **help someone who has not yet rolled**, the GM picks 1:',
    list: [
  ...
  },
  {
    id: 'clash',
    name: 'Clash',
    triggerOverride: 'When you **fight in melee or close quarters**, roll +STR: on a 10+, your maneuver works as expected (deal your damage) and pick 1:',
    list: [
  ...
  },
  {
    id: 'defend',
    name: 'Defend',
    triggerOverride: 'When you **take up a defensive stance or jump in to protect others**, roll +CON: on a 10+, hold 3 Readiness (or 4 if you bear a shield); on a 7-9, hold 1 Readiness (or 2 with a shield). You can spend Readiness 1-for-1 to:',
    list: [
  ...
  },
  {
    id: 'defy-danger',
    name: 'Defy Danger',
    triggerOverride: 'When **danger looms, the stakes are high, and you do something chancy**, check if another move applies. If not, roll...',
    list: [
  ...
  },
  {
    id: 'interfere',
    name: 'Interfere',
    triggerOverride: "When you **try to foil another PC's action and neither of you back down**, roll...",
    list: [
      '+STR to power through or test your might',
      '+DEX to employ speed, agility, or finesse',
      '+CON to endure or hold steady',
  ...
  },
  {
    id: 'know-things',
    name: 'Know Things',
    triggerOverride: "When you **consult your accumulated knowledge**, roll +INT: on a 10+, the GM will tell you something interesting and useful about the topic at hand; on a 7-9, the GM will tell you something interesting—it's on you to make it useful; either way, the GM might ask \"how do you know this?\"",
    citation: 'Book 1, p. 220',
  },
  {
    id: 'let-fly',
    name: 'Let Fly',
    triggerOverride: "When you **take an easy shot with a ranged weapon**, deal your damage. **If the shot is tricky or you're under pressure**, first roll +DEX: on a 10+, you have a clear shot, deal your damage; on a 7-9, pick 1:",
    list: [
  ...
  },
  {
    ...
    triggerOverride: "When you **press or entice an NPC**, say what you want them to do (or not do). If they **have reason to resist**, roll +CHA: on a 10+, they either do as you want or reveal the easiest way to convince them; on a 7-9, they reveal something you can do to convince them, though it'll likely be costly, tricky, or distasteful.",
    citation: 'Book 1, p. 224',
  },
  {
    id: 'persuade-pcs',
    name: 'Persuade (vs. PCs)',
    triggerOverride: 'When you **press or entice a PC and they resist**, ask their player: "Could I possibly get you to do this, yes or no?" If they say "no," let it drop.',
    footer: "If they say \"yes,\" you can roll +CHA: on a 10+, they mark XP if they do what you want, and if they don't, they must say how you could convince them; on a 7-9, they mark XP if they do what you want (but can refuse or make a counter-offer if they like).",
    citation: 'Book 1, p. 226',
  },
  {
    id: 'seek-insight',
    name: 'Seek Insight',
    triggerOverride: 'When you **study a situation or person**, looking to the GM for insight, roll +WIS: on a 10+, ask the GM 3 questions from the list below; on a 7-9, ask 1; either way, take advantage on your next move to act on the answers.',
    list: [
