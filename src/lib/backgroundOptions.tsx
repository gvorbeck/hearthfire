...
export const BACKGROUND_OPTIONS: Partial<
  Record<PlaybookType, BackgroundOption[]>
> = {
  blessed: [
    {
      value: "initiate",
    ...
    },
    {
      ...
      choices: {
        ...
        items: [
          ...
          {
            value: "haeris",
            label: "**Haeris** (from Gordin's Delve)",
            locked: true,
          },
...
You have an aviary in addition to your usual choice of special possessions. When you ***send a message via trained bird***, as is the way of the Judges of your order, the GM will tell you if and when you receive a response, and what it says.`,
    },
    {
      value: "prophet",
      title: "Prophet",
...
When you ***focus on your animal companion for a few moments***, you can use any of the actions you've marked below, no matter the distance between you. Mark 1 action at 1st level, then another at 3rd, 5th, 7th, and 9th.`,
      choices: {
        ...
        items: [
          {
            value: "gauge-distance",
            label: "Gauge its distance and direction from you",
          },
          { value: "call-back", label: "Call it back to your side" },
          { value: "sense-emotion", label: "Sense its emotional state" },
          {
            value: "brief-impression",
            label: "Get a brief impression of what it senses",
          },
          {
            value: "lend-strength",
            label:
...
You start with the Let's Make a Deal move and are Well Versed in the Things Below (go mark them now). You've also acquired 1 major arcanum:`,
      choices: {
        ...
        items: [
          ...
          {
            value: "staff-lidless-orb",
            label: "◊ The Staff of the Lidless Orb",
          },
        ],
      },
    },
...
- Something on your person is lost or breaks`,
    },
    {
      ...
      choices: {
        ...
        items: [
          {
            value: "loved-one-killed",
            label: "A loved one was killed or abducted",
          },
          {
            value: "someone-gave-life",
            label: "Someone gave their life to save you",
          },
          {
            value: "idol-sacrificed",
            label: "Your idol sacrificed themselves to save many",
          },
          { value: "dark-mystery", label: "You stumbled upon a dark mystery" },
          {
            value: "terrible-mistake",
            label: "You must make amends for a terrible mistake",
          },
        ],
      },
    },
