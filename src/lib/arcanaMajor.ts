...
export const MAJOR_ARCANA: MajorArcanum[] = [
      ...
      consequences: [
        {
          ...
          children: [
            { id: 'orb-eye-1a', text: 'Your other eye withers, atrophies, and goes pale and empty. Painful warts sprout all around the socket. Permanently mark the *miserable* debility.' },
          ],
        },
        {
          id: 'orb-scales',
        ...
        },
        {
          ...
          children: [
            { id: 'orb-beauty-a', text: 'Replace your instinct with "Disgust: To marvel at things horrific and grotesque."' },
            { id: 'orb-beauty-b', text: 'You can clearly see the ugliness in other people. When you first meet an NPC, you can ask the GM "What secret shame or guilt do they bear?" and get an honest answer.' },
          ],
        },
        {
          id: 'orb-elrash',
    ...
    mystery: {
      ...
      consequences: [
        ...
        },
        {
          ...
          children: [
            { id: 'spear-c4a', text: 'A lesser evil escapes from the roots of the tree. Ask the GM what is now loose in the world.' },
            { id: 'spear-c4b', text: 'The tree grows sick and weak, losing its leaves and sprouting only a few in spring.' },
            { id: 'spear-c4c', text: 'Some natural thing is tainted by the dark power beneath the tree, and goes forth to wreak evil.' },
            { id: 'spear-c4d', text: 'The tree dies. Its prisoners escape. And the Spear loses all power.' },
          ],
        },
      ],
    },
  ...
  },
  {
    ...
    mystery: {
      ...
      consequences: [
        { id: 'sphere-c1', text: 'You draw the attention of some powerful, hungry entity of the spirit world. It has your scent.' },
        { id: 'sphere-c2', text: 'Your physical body withers and fades—permanently mark the *weakened* debility.' },
        {
          id: 'sphere-c3',
          text: 'Your emotions dull. You can no longer be affected by fear, hate, passion, or other powerful emotions (for good or ill).',
          children: [
            { id: 'sphere-c3a', text: 'Replace your instinct with "Detachment: To distance yourself from human connections and emotions."' },
          ],
        },
        {
          id: 'sphere-c4',
          ...
          children: [
            { id: 'sphere-c4a', text: 'When you take damage from fire, roll twice and take the higher result.' },
          ],
        },
        { id: 'sphere-c5', text: 'When you **roll 6- at Death\'s Door**, you have no choice: gain the Ghost insert (with the Ice Sphere as your tether).' },
      ],
    },
  },
  {
    ...
    mystery: {
      ...
      consequences: [
        { id: 'mindgem-c1', text: 'It becomes frustrated/agitated and begins to obsessively do something destructive or dangerous to others.' },
        {
          id: 'mindgem-c2',
        ...
        { id: 'mindgem-c3', text: 'It develops a sense of pride; cross off the *meek* tag.' },
        {
          id: 'mindgem-c4',
          ...
          children: [
            { id: 'mindgem-c4a', text: 'It becomes aggressive and reckless in battle. Its attacks gain the *area* and *dangerous* tags.' },
          ],
        },
        { id: 'mindgem-c5', text: 'It remembers its original purpose. The GM will pick 1 or have you roll 1d4 on the table below to determine the Servant\'s new cost (replacing "wonder, excitement, joy"): 1 To punish — Victory against Hillfolk, sorcerers, the Things Below; 2 To preserve — Acquiring artifacts of the past, safely hiding them away; 3 To purge — Destroying artifacts of the Green Lords or Things Below; 4 To build — Progress towards building an enormous, enigmatic edifice.' },
        { id: 'mindgem-c6', text: 'Its instinct becomes "to pursue its purpose." You must Persuade it to do anything unrelated to that purpose, and it will flat-out refuse to act against its purpose.' },
        { id: 'mindgem-c7', text: 'It wanders off in pursuit of its purpose, implacably pursuing it. It is no longer a follower, though you might still be able to Persuade it.' },
      ],
    },
  },
  {
    ...
    tags: 'magical',
    description: 'Jagged hunks of black volcanic glass. Surely the swirling movement in their depths is a trick of light. And, surely, those hushed voices you\'ve been hearing are just the sighing wind. Surely.',
    frontMoves: [
      {
    ...
    mystery: {
      ...
      consequences: [
        { id: 'rocks-c1', text: 'The rocks all cease to function until each is caressed by a dying breath.' },
        { id: 'rocks-c2', text: '◻◻◻ The dark spirit in the rock you were using escapes, manifesting in the world. Cross off the Shadow Magic option that you just used until you force or convince the spirit to return to the rock.' },
        { id: 'rocks-c3', text: 'Your eyes turn jet black. You can see sharply in even utter darkness, but you see no color and are blinded by sunlight.' },
        { id: 'rocks-c4', text: 'You skin turns deathly pale or coal black (your choice) and chill to the touch. The sun burns your skin, but you go unharmed by even the bitterest cold.' },
        { id: 'rocks-c5', text: 'You begin to suffer from dark and troubling dreams. When you **Make Camp**, roll +WIS: **on a 10+**, a useful secret is revealed by your nightmares—ask the GM to describe them; **on a 7-9**, you get as good a night\'s sleep as you can; **on a 6-**, you get no rest for the night.' },
    ...
    mystery: {
      moves: [
        ...
        },
        {
          ...
          subtitle: 'wield the Blood-quenched Blade and leap headlong into battle against multiple foes',
      ...
      consequences: [
        ...
        },
        {
          ...
          children: [
            { id: 'sword-c2a', text: 'Your instinct becomes "Paranoia: to accuse someone of plotting against or wanting to steal the Blood-quenched Sword, and do something about it."' },
          ],
        },
        { id: 'sword-c3', text: 'You can no longer sleep or rest without the Blood-quenched Sword at hand.' },
        {
          id: 'sword-c4',
        ...
        { id: 'sword-c5', text: 'You can always ask the GM "Does this NPC disrespect me or intend to do me harm?" and the GM will answer honestly "Yes" or "No." If they answer "Yes," gain advantage to end their life and take disadvantage to do anything else.' },
      ],
    },
  },
  {
    ...
    mystery: {
      moves: [
        {
          ...
          subtitle: 'proudly bear the Shield of the Wisent Witch and call upon the spirits of the herd',
      ...
      consequences: [
        { id: 'shield-c1', text: 'You give off a strong, musky scent no matter how much you bathe. It is distinctive and easily recognized.' },
        { id: 'shield-c2', text: 'Over the next few days, you grow 4-6 inches.' },
        { id: 'shield-c3', text: 'Over the next few days, your body mass doubles. Your size and relative strength remain mostly the same.' },
        { id: 'shield-c4', text: 'You consume twice the normal amount of supplies or provisions each day.' },
        { id: 'shield-c5', text: 'You make an inordinate amount of noise; your voice booms, your feet stomp heavily, even your breathing is loud.' },
        { id: 'shield-c6', text: 'Your attacks all gain the *forceful* tag (and become more so if they already were *forceful*) and large weapons lose the *awkward* tag. Alas, you hardly know your own strength and must be careful to avoid breaking things (including your friends).' },
        { id: 'shield-c7', text: 'Predators sense that you would be delicious and will choose to attack and eat you before just about any other potential prey.' },
        { id: 'shield-c8', text: 'You become territorial and overly defensive of your allies. When someone or thing **disrespects you, challenges your authority, or directly threatens your allies**, you have disadvantage to do anything other than set them straight.' },
      ],
    },
  },
  {
      ...
      consequences: [
        {
          ...
          children: [
            { id: 'codex-c1a', text: 'Over a few days, you lose all your remaining hair and grow a fine layer of scales over all your skin except that on your face. Gain +1 armor.' },
          ],
        },
        {
          id: 'codex-c2',
          ...
          children: [
            { id: 'codex-c2a', text: 'Your heart rate and breathing slows, and you can hold supremely still for hours on end. You can easily be mistaken for dead. You only need to eat once every 3 days, but you gain no benefit from healing arts or magic.' },
          ],
        },
        {
          id: 'codex-c3',
          ...
          children: [
            { id: 'codex-c3a', text: 'Your eyes grow milky, you no longer blink, and you have trouble seeing things that aren\'t moving. Your tongue becomes forked, and you gain a preternatural sense of smell and touch.' },
            { id: 'codex-c3b', text: 'Anything that you perceive, Hec\'tumel perceives it too.' },
          ],
        },
      ],
    },
  },
  {
    ...
    mystery: {
      ...
      consequences: [
        { id: 'scepter-c1', text: 'Your skin becomes feverish. You always feel hot and can\'t bear to wear *warm* gear.' },
        { id: 'scepter-c2', text: 'Your eyes change, glowing like fiery embers. They flare with your temper.' },
        { id: 'scepter-c3', text: 'The crystal tip of the Scepter cracks, and you cannot use the Scepter\'s powers until you have "fed" the Scepter another chunk of red crystal, one at least the size of your fist.' },
        { id: 'scepter-c4', text: 'To gain any future charge, the victim you bleed must be awake and terrified.' },
        { id: 'scepter-c5', text: 'To gain any future charge, the blood-letting must be brutal, messy, and wanton.' },
        { id: 'scepter-c6', text: 'Henceforth, when you **incite someone to violence with the Scepter and they act as you suggest**, they lose themselves to primal bloodlust. They feel no pain and revel in carnage until they are killed, restrained, or crippled.' },
        { id: 'scepter-c7', text: 'When you **use Burning Hatred**, something on your person or within reach also catches fire.' },
        { id: 'scepter-c8', text: 'You always hear a dim howling in the back of your mind. When the wind blows, the howling grows in volume, making it difficult to hear anything other than insults or plans to commit violence.' },
        { id: 'scepter-c9', text: 'When you **Persuade using anything other than threats, pain, or violence**, the best you can get is a 7-9.' },
      ],
    },
  },
  {
    ...
    name: 'Ring of Daagon',
    tags: 'magical',
    description: 'A finely carved ring of copper, coated in verdigris and always a little damp. Its shape is that of a strange, reptilian creature devouring its own tail.',
    frontMoves: [
      {
        name: 'Don the Ring',
      ...
      consequences: [
        {
          ...
          children: [
            { id: 'daagon-c1a', text: 'You can breathe water through your skin, but must keep it moist or suffer increasing debilities.' },
          ],
        },
        {
          id: 'daagon-c2',
          ...
          children: [
            { id: 'daagon-c2a', text: 'Only raw flesh nourishes you, but you are immune to food-borne illness.' },
          ],
        },
        { id: 'daagon-c3', text: '◻◻◻ 1d6 sinkholes appear within a few miles of you. At the bottom of each, a megalith protrudes from standing water, attended by servants of Daagon.' },
        { id: 'daagon-c4', text: 'The ring\'s Cost becomes "Living, helpless, intelligent sacrifices."' },
      ],
    },
  },
  {
      ...
      consequences: [
        {
          ...
          children: [
            { id: 'scales-c1a', text: 'Mere minions and mindless horrors will no longer suffice. You only mark 1 for destroying a potent agent of chaos, such as a mighty demon or sorcerer.' },
          ],
        },
        { id: 'scales-c2', text: 'When you **use or knowingly submit to chaotic magic**, the Rune-laden Scales cease to benefit you or anyone you consider to be a friend or ally.' },
        {
          id: 'scales-c3',
          ...
          children: [
            { id: 'scales-c3a', text: 'When you **take any violent action out of anger, fear, or passion**, even against an agent of chaos, take disadvantage on all rolls until you ceremonially atone and purify yourself.' },
          ],
        },
        { id: 'scales-c4', text: 'You come to the attention of one of the mightiest of the Things Below, and they make your doom—or your corruption—a priority.' },
        { id: 'scales-c5', text: 'You ascend into a vision state, in which you meet the spirit of the last hero to wear the Scales. Should you refuse the quest they offer, the Rune-laden Scales cease to function.' },
      ],
    },
  },
  {
      ...
      moves: [
        ...
        },
        {
          ...
          follower: {
            ...
            hp: 10,
            armor: 1,
            damage: 'ghostly touch d4 (band, ignores armor) or host\'s weapon d6 (tags vary)',
  ...
  },
  {
    ...
    description: 'A series of branching, tree-like markings coursing up and down your skin. Usually pale blue, almost like veins, but when you become agitated they seem to glow, pulse, and ripple with light.\n\nThe markings are usually seen as a blessing of Tor (rainmaker, thunderhead, slayer-of-beasts). But like most blessings of the gods, they are also a great burden.',
    frontMoves: [
      {
    ...
    mystery: {
      ...
      consequences: [
        { id: 'storm-c1', text: '◻◻◻ Lightning begins to arc off of you, striking objects and creatures nearby at random for 2d6 damage (*near, forceful, loud*, ignores armor). This lasts until you calm down.' },
        { id: 'storm-c2', text: '◻◻ A gale of winds forms around you, as with Chosen of the Storm-bringer (even if you can\'t normally use that move). You can\'t dismiss it easily; the effects (including the disadvantage) continue until you calm down.' },
        { id: 'storm-c3', text: 'Name an NPC who is present and whose regard you value. They are terrified of the power you wield and grow distant.' },
        { id: 'storm-c4', text: 'From now on, when you gain Fury, gain +1 Fury. But you also have disadvantage on rolls to control your temper.' },
        { id: 'storm-c5', text: 'A storm forms (or worsens) in your immediate area. It arrives unnaturally fast, but not miraculously so.' },
        {
          id: 'storm-c6',
          ...
          children: [
            { id: 'storm-c6a', text: 'A terrible storm forms (as above) and the weather remains freakish for a few months. Your steading takes -2 to its next roll to generate Surplus, and its next Fortunes roll for Seasons Change is automatically a 6-. Other communities in the region likewise suffer.' },
          ],
        },
      ],
    },
  },
  {
    ...
    mystery: {
      ...
      consequences: [
        { id: 'words-c1', text: '◻◻◻ The Word\'s power draws the attention of every magical being for miles around. They will recognize you on sight as the bearer of the Word.' },
        { id: 'words-c2', text: '◻◻ The power of the Word overflows, affecting every possible target within *far* range to violent effect.' },
        { id: 'words-c3', text: 'Your voice takes on a metallic, inhuman edge. Henceforth, all creatures understand you as though you spoke their native tongue, but you can never again use language to lie or deceive.' },
        { id: 'words-c4', text: 'The Word tears reality, leaving a rift from which primordial power pours into the world. Expect all manner of strange and chaotic effects.' },
        { id: 'words-c5', text: 'You rouse an eternal, ancient being of Order. It seeks you out, implacably, to reprimand you for your reckless use of such primordial power.' },
      ],
    },
  },
  {
    ...
    mystery: {
      ...
      consequences: [
        { id: 'effigy-c1', text: 'Your heartbeat slows and your emotions dull. Magic cannot stir your emotions unless it specifically targets the effigy. Alas, you can no longer Burn Brightly.' },
        { id: 'effigy-c2', text: 'Your blood flows like sap and your muscles become like wood. Gain +1 armor and +4 max HP, but you can no longer regain HP via the Recover move. When you **Make Camp**, you must rest while touching soil or you get no benefit.' },
        { id: 'effigy-c3', text: 'Henceforth, when **anyone works magic upon the effigy**, it affects you instead and bypasses any defenses that you have in place (including Surrogate Suffering).' },
        { id: 'effigy-c4', text: 'Henceforth, when you **suffer physical harm while you hold Conduit**, you must spend it and use Surrogate Suffering.' },
        { id: 'effigy-c5', text: 'The effigy becomes both *fragile* and highly flammable. When you suffer damage from heat or fire, you take +1d6 damage. If the effigy suffers harm from heat or fire in your place, it will burst into flames and be destroyed.' },
        { id: 'effigy-c6', text: 'When you **roll 6- at Death\'s Door**, you have no choice: gain the Revenant insert until the effigy is destroyed (and you become a wraith controlled by the GM) or it is buried in a Red Grove (and you become an NPC spirit of that grove).' },
      ],
    },
  },
  {
    ...
    tags: 'magical',
    description: 'A ring of black metal bands, woven in an intricate pattern beyond the skills of modern smiths. The way the bands twist on each other seems to defy reality, and the weak-willed find themselves pondering the bands for minutes or hours.\n\nThe metal is always cold. Always.',
    frontMoves: [
      {
    ...
    mystery: {
      ...
      consequences: [
        { id: 'hlad-c1', text: '◻◻◻ A powerful earthquake strikes the area. Each time you choose this option, the quake is longer, more powerful, more destructive.' },
        {
          id: 'hlad-c2',
          text: 'The ring fuses to your flesh and bone and can no longer be removed without cutting off your finger.',
          children: [
            { id: 'hlad-c2a', text: 'The air in your presence is always noticeably colder, though you yourself are unharmed and unfazed by even the bitterest cold.' },
          ],
        },
        { id: 'hlad-c3', text: 'The ring wounds your soul, reducing your max HP by 4. Until your soul is healed, your instinct becomes "Hunger: to fill the emptiness inside you with excess." Should you roll a 6- on Death\'s Door, you die and become a wraith (a monster in the GM\'s control).' },
        { id: 'hlad-c4', text: 'The ring opens a gaping vortex, sucking in the life-force of everything around it (d10 damage, *near, area, grabby*, ignores armor) and weakening stone and metal and wood. You can, perhaps, close the vortex through a force of will.' },
        { id: 'hlad-c5', text: 'The earth shakes. The ring tears at your life-force (1d10 damage, *messy*, ignores armor, mark all three debilities). The ring is gone and your hand is left a withered and palsied thing. And somewhere, a hole has opened in the world.' },
      ],
    },
  },
  {
    ...
    mystery: {
      ...
      consequences: [
        { id: 'azure-c1', text: '◻◻◻ You are burned by the power you attempt to wield. Mark a debility and take 2d4 damage (ignores armor).' },
        { id: 'azure-c2', text: 'You become bound to the staff. You can call it to your hand from up to *far* range, but you fully suffer the effects of any harm or magic visited upon it.' },
        { id: 'azure-c3', text: 'Your eyes become a solid bluish white, darkening or brightening with your mood. You now see energy patterns, glowing brightly, which can obscure facial expressions and other details unless you focus.' },
        { id: 'azure-c4', text: 'Your skin takes on a bluish tint; your hair is streaked with white; the air about you thrums with power. Sensitive beings can easily sense your presence, even from afar.' },
        { id: 'azure-c5', text: 'Henceforth, any storm in your presence is unnaturally strong. If you spend a summer or a winter in a steading or within a day\'s march of one, the steading loses 1d4-1 Surplus due to storms.' },
        { id: 'azure-c6', text: 'Your body pulses with barely controlled energy. Henceforth, when you **roll +CON and get a 6-**, you unleash bolts of elemental power all about you (1d10 damage, *near, area, forceful, dangerous*) in addition to whatever else the GM says.' },
      ],
    },
  },
];
